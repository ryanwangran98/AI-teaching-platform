          ...
          {selectedMaterial && (
            <Box sx={{ pt: 2 }}>
              ...
              <Box sx={{ mt: 2, textAlign: 'center' }}>
                  ...
                  <Box sx={{ 
                    ...
                    {selectedMaterial.fileUrl ? (
                      <audio
                        ...
                        style={{ width: '100%' }}
                      >
                        <source src={getFullFileUrl(selectedMaterial.fileUrl)} type="audio/mpeg" />
                        <source src={getFullFileUrl(selectedMaterial.fileUrl)} type="audio/wav" />
                        <source src={getFullFileUrl(selectedMaterial.fileUrl)} type="audio/ogg" />
                        您的浏览器不支持音频播放
                      </audio>
                    ) : (
                      <Typography variant="h6" color="textSecondary">
                ...
                {['DOC', 'OTHER', 'ZIP'].includes(selectedMaterial.type) && (
                  <Box sx={{ 
                    height: 200, 
                    border: '1px solid #ccc', 
                    display: 'flex', 
                    ...
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography variant="h6" color="textSecondary" gutterBottom>
                        {getTypeLabel(selectedMaterial.type)}文件
                      </Typography>
                      <Typography variant="body2" color="textSecondary" gutterBottom>
                        此类型文件不支持在线预览，请下载后查看
                      </Typography>
